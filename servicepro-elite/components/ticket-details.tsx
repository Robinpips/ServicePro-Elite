          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="description" name="description" value={editedTicket.description} onChange={handleChange} />
              </div>
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="status">Status</Label>
                  <Select name="status" value={editedTicket.status} onValueChange={(value) => setEditedTicket(prev => prev ? { ...prev, status: value } : null)}>
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select name="priority" value={editedTicket.priority} onValueChange={(value) => setEditedTicket(prev => prev ? { ...prev, priority: value } : null)}>
                    <SelectTrigger>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {editedTicket.scheduledDate ? format(new Date(editedTicket.scheduledDate), "PPP") : <span>Pick a date</span>}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto p-0">
                      <Calendar
                        ...
                        onSelect={(date) => setEditedTicket(prev => prev ? { ...prev, scheduledDate: date } : null)}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
